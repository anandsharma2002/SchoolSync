...
import AnandSharmaProfile from '../assets/Photos/AnandSharma.jpg'
    ...
    <div className='min-h-screen flex flex-col'>
      <div className='w-[98%] mx-auto px-4 py-8 flex-grow'>
        ...
        <div className='mt-10 '>
          {/* Card 2 */}
          <motion.div
            className='w-[98%] mx-auto bg-white rounded-lg shadow-lg overflow-hidden mb-8 border border-gray-200'
          ...
          >
            <div className=' flex flex-col md:flex-row justify-center items-center'>
              <div className='md:w-1/2 p-8'>
                <h3 className='text-[30px] font-bold mb-4 text-blue-600'>Founder</h3>
                <h4 className='text-[25px] font-bold mb-4 text-blue-600'>Anand Sharma</h4>
                <p className='text-[18px] text-gray-800 mb-4'>
                  Keep moving forward and don't give up.
                </p>
              </div>
              <div className='md:w-1/2 bg-blue-50 flex items-center justify-center'>
                <img src={AnandSharmaProfile} alt="Teacher Portal" className='' />
              </div>
            </div>
          </motion.div>
          ...
          >
            <div className=' flex flex-col md:flex-row-reverse justify-center items-center'>
              <div className='md:w-1/2 p-8'>
                <h3 className='text-[30px] font-bold mb-4 text-blue-600'>Co-Founder</h3>
                <h4 className='text-[25px] font-bold mb-4 text-blue-600'>Vinisha Rathore</h4>
                <p className='text-[18px] text-gray-800 mb-4'>
          ...
          >
            <div className=' flex flex-col md:flex-row justify-center items-center'>
              <div className='md:w-1/2 p-8'>
                <h3 className='text-[30px] font-bold mb-4 text-blue-600'>Co-Founder</h3>
                <h4 className='text-[25px] font-bold mb-4 text-blue-600'>Manjeet kadyan</h4>
                <p className='text-[18px] text-gray-800 mb-4'>
                  Think positive.
                </p>
              </div>

  ...
  const contactInfo: ContactInfo[] = [
    {
      icon: Mail,
      title: 'Email Us',
      details: ['hello@edumanage.com', 'support@edumanage.com']
    },
    {
      icon: Phone,
      title: 'Call Us',
    ...
    },
    {
      icon: MapPin,
      title: 'Visit Us',
      details: ['123 Education Boulevard', 'Tech District, TC 12345']
    },
    {
      icon: Clock,
      title: 'Business Hours',
      details: ['Mon - Fri: 9AM - 6PM', 'Support: 24/7']
    }
  ];
      ...
      <section className="relative bg-gradient-to-br from-primary-50 via-white to-blue-50 py-20 lg:py-32 overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h1 className="text-4xl lg:text-6xl font-bold text-gray-900 leading-tight mb-8">
            Get in
            <span className="bg-gradient-to-r from-primary-600 to-blue-600 bg-clip-text text-transparent"> Touch</span>
          </h1>
          <p className="text-xl text-gray-600 max-w-3xl mx-auto mb-12 leading-relaxed">
            Ready to transform your school's management system? We're here to help you get started 
            ...
            <div className="grid lg:grid-cols-2">
              ...
              <div className="p-8 lg:p-12">
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <button
                    type="submit"
                    className="w-full bg-gradient-to-r from-primary-600 to-primary-700 text-white px-8 py-4 rounded-xl font-bold hover:from-primary-700 hover:to-primary-800 transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-xl flex items-center justify-center"
                  >
              ...
              <div className="bg-gradient-to-br from-primary-600 to-primary-800 p-8 lg:p-12 text-white">
                ...
                <div className="space-y-6">
                  <div>
                    ...
                    <p className="text-primary-100">We typically respond to all inquiries within 24 hours during business days.</p>
                  </div>
                  <div>
                    <h4 className="font-semibold mb-2">Free Consultation</h4>
                    <p className="text-primary-100">Schedule a free 30-minute consultation to discuss your school's specific needs.</p>
                  </div>
                  <div>
                    <h4 className="font-semibold mb-2">Custom Demo</h4>
                    <p className="text-primary-100">Get a personalized demo tailored to your institution's requirements.</p>
                  </div>
                </div>
                ...
                <div className="mt-12 pt-8 border-t border-primary-400">
                  ...
                  <p className="text-primary-100 mt-2">Available Mon-Fri, 9AM-6PM EST</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-3xl lg:text-5xl font-bold text-gray-900 mb-6">
              Quick
              <span className="bg-gradient-to-r from-primary-600 to-blue-600 bg-clip-text text-transparent"> Answers</span>
            </h2>
            <p className="text-xl text-gray-600">Common questions we receive from schools and educators.</p>
          </div>
          
          <div className="space-y-6">
            <div className="bg-gradient-to-r from-gray-50 to-blue-50 p-8 rounded-2xl">
              <h3 className="text-xl font-bold text-gray-900 mb-4">How long does implementation take?</h3>
              <p className="text-gray-600">Most schools are up and running within 1-2 weeks. We provide full onboarding support and training for your staff.</p>
            </div>
            
            <div className="bg-gradient-to-r from-gray-50 to-blue-50 p-8 rounded-2xl">
              <h3 className="text-xl font-bold text-gray-900 mb-4">Can you import our existing data?</h3>
              <p className="text-gray-600">Yes! We can import student records, grades, and other data from most common school management systems. Our team handles the migration process.</p>
            </div>
            
            <div className="bg-gradient-to-r from-gray-50 to-blue-50 p-8 rounded-2xl">
              <h3 className="text-xl font-bold text-gray-900 mb-4">Do you offer training for our staff?</h3>
              <p className="text-gray-600">Absolutely. We provide comprehensive training sessions, video tutorials, and ongoing support to ensure your team feels confident using EduManage.</p>
            </div>
          </div>
        </div>
      </section>

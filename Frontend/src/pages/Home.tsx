...
const Home: React.FC = () => {
  const features: Feature[] = [
    ...
    },
    {
      ...
      description: 'Create, organize, and manage courses with curriculum planning and resource allocation.',
      gradient: 'from-purple-500 to-pink-500'
    },
    {
      icon: BarChart3,
      title: 'Analytics & Reports',
      description: 'Detailed insights into student performance, attendance, and institutional metrics.',
      gradient: 'from-green-500 to-emerald-500'
    },
    {
      icon: Shield,
      title: 'Secure & Reliable',
      description: 'Enterprise-grade security with data encryption and regular automated backups.',
  ...
  const testimonials: Testimonial[] = [
    {
      ...
      content: 'EduManage has transformed how we handle student data and communication. It\'s intuitive and powerful.',
      rating: 5,
    ...
    },
    {
      ...
      content: 'The reporting features are exceptional. We can now make data-driven decisions quickly and efficiently.',
      rating: 5,
    ...
    },
    {
      ...
      content: 'Student enrollment and management has never been easier. Our staff loves the user-friendly interface.',
      rating: 5,
  ...
  const stats: Stat[] = [
    ...
    { number: '500+', label: 'Schools Trust Us', icon: BookOpen },
    ...
    <div className="min-h-screen">
      ...
      <section className="relative bg-gradient-to-br from-primary-50 via-white to-blue-50 py-20 lg:py-32 overflow-hidden">
        ...
        <div className="absolute inset-0 opacity-40">
          ...
          <div className="absolute bottom-20 right-10 w-72 h-72 bg-blue-200 rounded-full mix-blend-multiply filter blur-xl animate-bounce" style={{animationDelay: '2s'}}></div>
        </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="animate-fade-in">
              ...
              <h1 className="text-4xl lg:text-6xl font-bold text-gray-900 leading-tight mb-6">
                Streamline Your
                <span className="bg-gradient-to-r from-primary-600 to-blue-600 bg-clip-text text-transparent"> School Management</span>
              </h1>
              <p className="text-xl text-gray-600 mb-8 leading-relaxed">
                Comprehensive school management system that simplifies administration, 
                enhances communication, and improves student outcomes with modern technology.
              </p>
              <div className="flex flex-col sm:flex-row gap-4 mb-8">
                <Link
                  to="/pricing"
                  className="group bg-gradient-to-r from-primary-600 to-primary-700 text-white px-8 py-4 rounded-xl text-lg font-semibold hover:from-primary-700 hover:to-primary-800 transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-xl text-center flex items-center justify-center"
                >
                  Start Free Trial
                ...
                <div className="space-y-6">
                  <div className="flex items-center justify-between p-4 bg-gradient-to-r from-blue-50 to-cyan-50 rounded-2xl">
                    <div className="flex items-center space-x-3">
                      ...
                      <div>
                        ...
                        <div className="text-2xl font-bold bg-gradient-to-r from-blue-600 to-cyan-600 bg-clip-text text-transparent">1,247</div>
                      </div>
                    </div>
                  ...
                  <div className="flex items-center justify-between p-4 bg-gradient-to-r from-green-50 to-emerald-50 rounded-2xl">
                    <div className="flex items-center space-x-3">
                      ...
                      <div>
                        ...
                        <div className="text-2xl font-bold bg-gradient-to-r from-green-600 to-emerald-600 bg-clip-text text-transparent">48</div>
                      </div>
                    </div>
                  ...
                  <div className="flex items-center justify-between p-4 bg-gradient-to-r from-purple-50 to-pink-50 rounded-2xl">
                    <div className="flex items-center space-x-3">
                      ...
                      <div>
                        <div className="font-semibold text-gray-900">Attendance Rate</div>
                        <div className="text-2xl font-bold bg-gradient-to-r from-purple-600 to-pink-600 bg-clip-text text-transparent">94.5%</div>
                      </div>
                    </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-3xl lg:text-5xl font-bold text-gray-900 mb-6">
              ...
              <span className="bg-gradient-to-r from-primary-600 to-blue-600 bg-clip-text text-transparent"> Manage Your School</span>
            </h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Our comprehensive platform provides all the tools you need to streamline operations and focus on what matters most - education.
            </p>
          </div>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-3xl lg:text-5xl font-bold text-gray-900 mb-6">
              Trusted by 
              <span className="bg-gradient-to-r from-primary-600 to-blue-600 bg-clip-text text-transparent"> Educators Worldwide</span>
            </h2>
      ...
      <section className="py-20 bg-gradient-to-r from-primary-600 via-primary-700 to-blue-600 relative overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-blue-100 mb-10 max-w-2xl mx-auto">
            Join thousands of schools that have already streamlined their operations with EduManage.
          </p>

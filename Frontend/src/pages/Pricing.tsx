...
const Pricing: React.FC = () => {
  const pricingPlans: PricingPlan[] = [
    ...
    },
    {
      ...
      price: 'Custom',
      period: 'pricing',
      description: 'Tailored solutions for large school districts and universities.',
      features: [
        'Unlimited students',
  ...
  const detailedFeatures: PricingFeature[] = [
    { name: 'Student Management', basic: true, professional: true, enterprise: true },
    { name: 'Grade Book', basic: true, professional: true, enterprise: true },
    { name: 'Attendance Tracking', basic: true, professional: true, enterprise: true },
    { name: 'Parent Portal', basic: false, professional: true, enterprise: true },
    ...
    { name: 'Dedicated Support', basic: false, professional: false, enterprise: true },
    { name: 'Custom Integrations', basic: false, professional: false, enterprise: 'Available' }
  ];
      ...
      <section className="relative bg-gradient-to-br from-primary-50 via-white to-blue-50 py-20 lg:py-32 overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h1 className="text-4xl lg:text-6xl font-bold text-gray-900 leading-tight mb-8">
            Simple, Transparent
            <span className="bg-gradient-to-r from-primary-600 to-blue-600 bg-clip-text text-transparent"> Pricing</span>
          </h1>
          <p className="text-xl text-gray-600 max-w-3xl mx-auto mb-12 leading-relaxed">
            Choose the perfect plan for your school. Start with a free 30-day trial, 
          ...
          <div className="inline-flex items-center bg-white/80 backdrop-blur-sm rounded-2xl p-2 shadow-lg border border-gray-100">
            <div className="bg-primary-600 text-white px-6 py-3 rounded-xl font-medium">Monthly</div>
            <div className="text-gray-700 px-6 py-3 font-medium">Yearly (Save 20%)</div>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-3xl lg:text-5xl font-bold text-gray-900 mb-6">
              Compare
              <span className="bg-gradient-to-r from-primary-600 to-blue-600 bg-clip-text text-transparent"> Features</span>
            </h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              See exactly what's included in each plan to make the best choice for your school.
            </p>
          </div>
            ...
            <div className="overflow-x-auto">
              <table className="w-full">
                <thead className="bg-gray-50">
                  <tr>
                    <th className="px-6 py-4 text-left text-lg font-bold text-gray-900">Features</th>
                    <th className="px-6 py-4 text-center text-lg font-bold text-gray-900">Basic</th>
                    <th className="px-6 py-4 text-center text-lg font-bold text-primary-600">Professional</th>
                    <th className="px-6 py-4 text-center text-lg font-bold text-gray-900">Enterprise</th>
                  </tr>
                </thead>
                    ...
                    <tr key={index} className="hover:bg-gray-50 transition-colors duration-200">
                      ...
                      <td className="px-6 py-4 text-center">
                        {feature.enterprise === true ? (
                          ...
                          <span className="text-primary-600 font-medium">{feature.enterprise}</span>
                        )}
                      </td>
                    </tr>
                  ))}
      ...
      <section className="py-20 bg-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-3xl lg:text-5xl font-bold text-gray-900 mb-6">
              Frequently Asked
              <span className="bg-gradient-to-r from-primary-600 to-blue-600 bg-clip-text text-transparent"> Questions</span>
            </h2>
          </div>
          ...
          <div className="space-y-8">
            ...
            <div className="bg-gradient-to-r from-gray-50 to-blue-50 p-8 rounded-2xl">
              ...
              <p className="text-gray-600">Absolutely! We offer a 30-day free trial with full access to all Professional features. No credit card required to start.</p>
            </div>
            
            <div className="bg-gradient-to-r from-gray-50 to-blue-50 p-8 rounded-2xl">
              <h3 className="text-xl font-bold text-gray-900 mb-4">What kind of support do you provide?</h3>
              <p className="text-gray-600">We provide email support for Basic plans, priority support for Professional plans, and dedicated support with phone access for Enterprise customers.</p>
            </div>
          </div>
        </div>
      </section>
